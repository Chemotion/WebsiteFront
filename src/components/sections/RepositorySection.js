...
const RepositorySection = () => {
  ...
  return (
    <section
      ...
      className="mb-28 w-full max-w-6xl px-4"
      aria-labelledby="repository-section-heading">
      <div className="flex flex-col items-center justify-between overflow-hidden rounded-md border-2 border-[#4d5559] p-6 lg:flex-row lg:items-stretch lg:p-6">
        <div className="flex-col justify-between space-y-6 text-center lg:mx-4 lg:flex lg:w-[45%] lg:p-4 lg:text-left">
          <h1
            ...
            aria-label="Chemotion Repository Heading">
            {content?.title}
          </h1>
          <div className="space-y-4 text-base text-gray-700" aria-label="Repository features">
          ...
          <div className="flex justify-center lg:justify-start">
            <a
              ...
              className="inline-block rounded-md border-2 border-[#4d5559] bg-[#4d5559] px-8 py-3 text-center text-xl font-semibold
