  ...
  return (
    <section
      ...
      <div className="flex flex-col items-center justify-between overflow-hidden rounded-md border-2 border-[#e63946] p-6 lg:flex-row lg:items-stretch lg:p-6">
        ...
        <div
          className="relative mt-8 flex aspect-[3/2] w-full justify-center overflow-hidden rounded-md border-2 border-[#e63946] px-2 lg:my-2 lg:mr-2 lg:mt-0 lg:w-1/2 lg:justify-end lg:px-0"
          aria-hidden="true">
          {content?.image?.url ? (
            <Image
